do
    ...
    if eq(time3,tostring(Base64.Decode(res1.data)),true) then
        ...
        function library:Window(TitleWhite, TitleBlue)
            ...
            Cool.ZIndex = 2
            Cool.Image = "rbxassetid://7625841847"
            BloxburgCool.Name = "BloxburgCool"
            BloxburgCool.Parent = MainUIFrame
            BloxburgCool.BackgroundColor3 = Color3.fromRGB(0, 0, 0)
            BloxburgCool.BorderSizePixel = 0
            BloxburgCool.Size = UDim2.new(0, 118, 0, 110)
            ...
            TabsHolder.ImageColor3 = Color3.fromRGB(0, 0, 0)
            ...
            BloxburgTitle1.BackgroundColor3 = Color3.fromRGB(0, 0, 0)
            ...
            BloxburgHubTitle.TextColor3 = Color3.fromRGB(255, 0, 0)
            ...
            function window:Tab(name)
                ...
                TabSelected.BackgroundColor3 = Color3.fromRGB(0, 0, 0)
                ...
                TabTOpFrame.BackgroundColor3 = Color3.fromRGB(255, 0, 0)
                TabTOpFrame.BorderColor3 = Color3.fromRGB(255, 0, 0)
                ...
                TabBottomFrame.BackgroundColor3 = Color3.fromRGB(255, 0, 0)
                TabBottomFrame.BorderColor3 = Color3.fromRGB(255, 0, 0)
                ...
                function tab:Section(name)
                    ...
                    function section:Label(name)
                        ...
                        LabelBack.BackgroundColor3 = Color3.fromRGB(0, 0, 0)
                    ...
                    function section:Slider(name, options, callback)
                        ...
                        Sliderhandle.ImageColor3 = Color3.fromRGB(255, 0, 0)
                    ...
                    function section:Box(name, callback)
                        ...
                        TextBoxMain.BackgroundColor3 = Color3.fromRGB(0, 0, 0)
                    ...
                    function section:Picker(name, options, callback)
                        ...
                        PickerBack.BackgroundColor3 = Color3.fromRGB(0, 0, 0)
                        ...
                        for i, v in next, options do
                            ...
                            if activeButton == nil then
                                ...
                                OptionDeselected.TextColor3 = Color3.fromRGB(255, 0, 0)
                                if callback then
                                    callback(v)
                                end
                            end
                    ...
                    function section:Toggle(name, callback)
                        ...
                        ToggleBackButton.BackgroundColor3 = Color3.fromRGB(0, 0, 0)
                        ...
                        ToggleBackButton.MouseButton1Click:Connect(function()--better color pls
                            if ToggleIndicator.ImageColor3 == Color3.fromRGB(255, 0, 0) then
                        ...
                        function toggle:Update(bool)
                            if ToggleIndicator.ImageColor3 == Color3.fromRGB(255, 0, 0) and bool == false then
                                tweenObject(ToggleIndicator, {
                                    ImageColor3 = Color3.fromRGB(0, 0, 0)
                                }, 0.1)
                                if callback then
        ...
        local Window = library:Window("Bloxburg", "Santos Hub")
